...
from stack_exchange_python_sdk.model.tag_synonyms import TagSynonyms as TagSynonymsSchema

from stack_exchange_python_sdk.type.tag_synonyms import TagSynonyms

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.tag_synonyms import TagSynonyms as TagSynonymsPydantic
...
SchemaFor200ResponseBody = TagSynonymsSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_synonyms_mapped_args(
        self,
        tags: str,
        site: str,
    ...
    async def _alist_synonyms_oapg(
        self,
...
class ListSynonymsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_synonyms(
        self,
        tags: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_synonyms_mapped_args(
            tags=tags,
            site=site,
            order=order,
            max=max,
        ...
        return await self._alist_synonyms_oapg(
    ...
    def list_synonyms(
        ...
        return self._list_synonyms_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListSynonyms(BaseApi):
    ...
    async def alist_synonyms(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_synonyms(
            tags=tags,
            site=site,
            order=order,
            max=max,
        ...
        if validate:
            return RootModel[TagSynonymsPydantic](raw_response.body).root
        return api_client.construct_model_instance(TagSynonymsPydantic, raw_response.body)
    ...
    def list_synonyms(
        ...
        raw_response = self.raw.list_synonyms(
            tags=tags,
            site=site,
            order=order,
            max=max,
