...
from stack_exchange_python_sdk.model.answers import Answers as AnswersSchema

from stack_exchange_python_sdk.type.answers import Answers

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.answers import Answers as AnswersPydantic
...
SchemaFor200ResponseBody = AnswersSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_list_by_question_ids_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_list_by_question_ids_oapg(
        self,
    ...
    def _get_list_by_question_ids_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetListByQuestionIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_list_by_question_ids(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_list_by_question_ids_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._aget_list_by_question_ids_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_list_by_question_ids(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        return self._get_list_by_question_ids_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetListByQuestionIds(BaseApi):
    ...
    async def aget_list_by_question_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_list_by_question_ids(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        if validate:
            return RootModel[AnswersPydantic](raw_response.body).root
        return api_client.construct_model_instance(AnswersPydantic, raw_response.body)
    ...
    def get_list_by_question_ids(
        ...
        raw_response = self.raw.get_list_by_question_ids(
            ids=ids,
            site=site,
            order=order,
            max=max,
