...
class BaseApi(api_client.Api):
    ...
    def _list_no_answer_questions_0_mapped_args(
        self,
        site: str,
    ...
    async def _alist_no_answer_questions_0_oapg(
        self,
    ...
    def _list_no_answer_questions_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListNoAnswerQuestions0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_no_answer_questions_0(
        self,
        site: str,
        tagged: typing.Optional[str] = None,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_no_answer_questions_0_mapped_args(
            site=site,
            tagged=tagged,
            order=order,
            max=max,
        ...
        return await self._alist_no_answer_questions_0_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_no_answer_questions_0(
        self,
        site: str,
        tagged: typing.Optional[str] = None,
        order: typing.Optional[str] = None,
        ...
        return self._list_no_answer_questions_0_oapg(
            query_params=args.query,
        )

class ListNoAnswerQuestions0(BaseApi):
    ...
    async def alist_no_answer_questions_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_no_answer_questions_0(
            site=site,
            tagged=tagged,
            order=order,
            max=max,
    ...
    def list_no_answer_questions_0(
        ...
        raw_response = self.raw.list_no_answer_questions_0(
            site=site,
            tagged=tagged,
            order=order,
            max=max,
