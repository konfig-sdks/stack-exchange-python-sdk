...
from stack_exchange_python_sdk.model.write_permissions import WritePermissions as WritePermissionsSchema

from stack_exchange_python_sdk.type.write_permissions import WritePermissions

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.write_permissions import WritePermissions as WritePermissionsPydantic
...
SchemaFor200ResponseBody = WritePermissionsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WritePermissions
...
class BaseApi(api_client.Api):
    ...
    def _get_user_write_permissions_mapped_args(
        self,
        site: str,
    ...
    async def _aget_user_write_permissions_oapg(
        self,
    ...
    def _get_user_write_permissions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserWritePermissionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_write_permissions(
        self,
        site: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_write_permissions_mapped_args(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        return await self._aget_user_write_permissions_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_user_write_permissions(
        self,
        site: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        return self._get_user_write_permissions_oapg(
            query_params=args.query,
        )

class GetUserWritePermissions(BaseApi):
    ...
    async def aget_user_write_permissions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WritePermissionsPydantic:
        raw_response = await self.raw.aget_user_write_permissions(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        if validate:
            return RootModel[WritePermissionsPydantic](raw_response.body).root
        return api_client.construct_model_instance(WritePermissionsPydantic, raw_response.body)
    ...
    def get_user_write_permissions(
        ...
        raw_response = self.raw.get_user_write_permissions(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
