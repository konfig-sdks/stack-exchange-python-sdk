...
class BaseApi(api_client.Api):
    ...
    def _list_owned_comments_mapped_args(
        self,
        site: str,
    ...
    async def _alist_owned_comments_oapg(
        self,
...
class ListOwnedCommentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_owned_comments(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_owned_comments_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._alist_owned_comments_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_owned_comments(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        return self._list_owned_comments_oapg(
            query_params=args.query,
        )

class ListOwnedComments(BaseApi):
    ...
    async def alist_owned_comments(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_owned_comments(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def list_owned_comments(
        ...
        raw_response = self.raw.list_owned_comments(
            site=site,
            order=order,
            max=max,
            min=min,
