...
class InfoObjectSite(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def aliases() -> typing.Type['InfoObjectSiteAliases']:
                return InfoObjectSiteAliases
            ...
            @staticmethod
            def markdown_extensions() -> typing.Type['InfoObjectSiteMarkdownExtensions']:
                return InfoObjectSiteMarkdownExtensions
            name = schemas.StrSchema
            open_beta_date = schemas.IntSchema
        
            @staticmethod
            def related_sites() -> typing.Type['InfoObjectSiteRelatedSites']:
                return InfoObjectSiteRelatedSites
            site_state = schemas.StrSchema
            site_type = schemas.StrSchema
            site_url = schemas.StrSchema
        
            @staticmethod
            def styling() -> typing.Type['InfoObjectSiteStyling']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["aliases"]) -> 'InfoObjectSiteAliases': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["markdown_extensions"]) -> 'InfoObjectSiteMarkdownExtensions': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["related_sites"]) -> 'InfoObjectSiteRelatedSites': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["styling"]) -> 'InfoObjectSiteStyling': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["aliases"]) -> typing.Union['InfoObjectSiteAliases', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["markdown_extensions"]) -> typing.Union['InfoObjectSiteMarkdownExtensions', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["related_sites"]) -> typing.Union['InfoObjectSiteRelatedSites', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["styling"]) -> typing.Union['InfoObjectSiteStyling', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        aliases: typing.Union['InfoObjectSiteAliases', schemas.Unset] = schemas.unset,
        ...
        markdown_extensions: typing.Union['InfoObjectSiteMarkdownExtensions', schemas.Unset] = schemas.unset,
        ...
        related_sites: typing.Union['InfoObjectSiteRelatedSites', schemas.Unset] = schemas.unset,
        ...
        styling: typing.Union['InfoObjectSiteStyling', schemas.Unset] = schemas.unset,
