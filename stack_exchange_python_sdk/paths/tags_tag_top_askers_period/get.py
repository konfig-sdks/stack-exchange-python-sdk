...
from stack_exchange_python_sdk.model.tag_score_objects import TagScoreObjects as TagScoreObjectsSchema

from stack_exchange_python_sdk.type.tag_score_objects import TagScoreObjects

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.tag_score_objects import TagScoreObjects as TagScoreObjectsPydantic
...
request_path_period = api_client.PathParameter(
    name="period",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PeriodSchema,
    required=True,
)
SchemaFor200ResponseBody = TagScoreObjectsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TagScoreObjects
...
class BaseApi(api_client.Api):
    ...
    def _get_top_askers_by_period_mapped_args(
        self,
        tag: str,
        period: str,
        site: str,
    ...
    async def _aget_top_askers_by_period_oapg(
        self,
    ...
    def _get_top_askers_by_period_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetTopAskersByPeriodRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_top_askers_by_period(
        self,
        tag: str,
        period: str,
        site: str,
        ...
        **kwargs,
        ...
        args = self._get_top_askers_by_period_mapped_args(
            tag=tag,
            period=period,
            site=site,
            pagesize=pagesize,
        ...
        return await self._aget_top_askers_by_period_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_top_askers_by_period(
        self,
        tag: str,
        period: str,
        site: str,
        ...
        return self._get_top_askers_by_period_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTopAskersByPeriod(BaseApi):
    ...
    async def aget_top_askers_by_period(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TagScoreObjectsPydantic:
        raw_response = await self.raw.aget_top_askers_by_period(
            tag=tag,
            period=period,
            site=site,
            pagesize=pagesize,
        ...
        if validate:
            return RootModel[TagScoreObjectsPydantic](raw_response.body).root
        return api_client.construct_model_instance(TagScoreObjectsPydantic, raw_response.body)
    ...
    def get_top_askers_by_period(
        ...
        raw_response = self.raw.get_top_askers_by_period(
            tag=tag,
            period=period,
            site=site,
            pagesize=pagesize,
