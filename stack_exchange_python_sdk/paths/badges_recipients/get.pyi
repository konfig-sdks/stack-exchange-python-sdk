...
class BaseApi(api_client.Api):
    ...
    def _get_recent_awarded_badges_mapped_args(
        self,
        site: str,
    ...
    async def _aget_recent_awarded_badges_oapg(
        self,
    ...
    def _get_recent_awarded_badges_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetRecentAwardedBadgesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recent_awarded_badges(
        self,
        site: str,
        fromdate: typing.Optional[int] = None,
        todate: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_recent_awarded_badges_mapped_args(
            site=site,
            fromdate=fromdate,
            todate=todate,
            pagesize=pagesize,
        ...
        return await self._aget_recent_awarded_badges_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_recent_awarded_badges(
        self,
        site: str,
        fromdate: typing.Optional[int] = None,
        todate: typing.Optional[int] = None,
        ...
        return self._get_recent_awarded_badges_oapg(
            query_params=args.query,
        )

class GetRecentAwardedBadges(BaseApi):
    ...
    async def aget_recent_awarded_badges(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_recent_awarded_badges(
            site=site,
            fromdate=fromdate,
            todate=todate,
            pagesize=pagesize,
    ...
    def get_recent_awarded_badges(
        ...
        raw_response = self.raw.get_recent_awarded_badges(
            site=site,
            fromdate=fromdate,
            todate=todate,
            pagesize=pagesize,
