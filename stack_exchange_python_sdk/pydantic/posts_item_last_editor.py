...
from stack_exchange_python_sdk.pydantic.posts_item_last_editor_badge_counts import PostsItemLastEditorBadgeCounts

class PostsItemLastEditor(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[PostsItemLastEditorBadgeCounts] = Field(None, alias='badge_counts')
