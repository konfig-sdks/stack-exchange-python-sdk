...
from stack_exchange_python_sdk.model.reputation_changes import ReputationChanges as ReputationChangesSchema

from stack_exchange_python_sdk.type.reputation_changes import ReputationChanges

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.reputation_changes import ReputationChanges as ReputationChangesPydantic
...
SchemaFor200ResponseBody = ReputationChangesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReputationChanges
...
class BaseApi(api_client.Api):
    ...
    def _get_reputation_changes_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_reputation_changes_oapg(
        self,
    ...
    def _get_reputation_changes_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetReputationChangesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_reputation_changes(
        self,
        ids: str,
        site: str,
        fromdate: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_reputation_changes_mapped_args(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        return await self._aget_reputation_changes_oapg(
    ...
    def get_reputation_changes(
        ...
        return self._get_reputation_changes_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetReputationChanges(BaseApi):
    ...
    async def aget_reputation_changes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReputationChangesPydantic:
        raw_response = await self.raw.aget_reputation_changes(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        if validate:
            return RootModel[ReputationChangesPydantic](raw_response.body).root
        return api_client.construct_model_instance(ReputationChangesPydantic, raw_response.body)
    ...
    def get_reputation_changes(
        ...
        raw_response = self.raw.get_reputation_changes(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
