...
class BaseApi(api_client.Api):
    ...
    def _get_user_unread_notifications_mapped_args(
        self,
    ...
    async def _aget_user_unread_notifications_oapg(
        self,
    ...
    def _get_user_unread_notifications_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserUnreadNotificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_unread_notifications(
        self,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_unread_notifications_mapped_args(
            pagesize=pagesize,
            page=page,
            filter=filter,
            param_callback=param_callback,
        )
        return await self._aget_user_unread_notifications_oapg(
    ...
    def get_user_unread_notifications(
        ...
        return self._get_user_unread_notifications_oapg(
            query_params=args.query,
        )

class GetUserUnreadNotifications(BaseApi):
    ...
    async def aget_user_unread_notifications(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_unread_notifications(
            pagesize=pagesize,
            page=page,
            filter=filter,
            param_callback=param_callback,
    ...
    def get_user_unread_notifications(
        ...
        raw_response = self.raw.get_user_unread_notifications(
            pagesize=pagesize,
            page=page,
            filter=filter,
            param_callback=param_callback,
