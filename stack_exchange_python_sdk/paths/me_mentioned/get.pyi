...
class BaseApi(api_client.Api):
    ...
    def _user_comments_list_mapped_args(
        self,
        site: str,
    ...
    async def _auser_comments_list_oapg(
        self,
...
class UserCommentsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def auser_comments_list(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._user_comments_list_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._auser_comments_list_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def user_comments_list(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        return self._user_comments_list_oapg(
            query_params=args.query,
        )

class UserCommentsList(BaseApi):
    ...
    async def auser_comments_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.auser_comments_list(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def user_comments_list(
        ...
        raw_response = self.raw.user_comments_list(
            site=site,
            order=order,
            max=max,
            min=min,
