...
from stack_exchange_python_sdk.pydantic.created_comment_owner_badge_counts import CreatedCommentOwnerBadgeCounts

class CreatedCommentOwner(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[CreatedCommentOwnerBadgeCounts] = Field(None, alias='badge_counts')
