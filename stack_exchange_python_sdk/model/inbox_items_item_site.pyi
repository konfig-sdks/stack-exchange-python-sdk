...
class InboxItemsItemSite(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def aliases() -> typing.Type['InboxItemsItemSiteAliases']:
                return InboxItemsItemSiteAliases
            ...
            @staticmethod
            def markdown_extensions() -> typing.Type['InboxItemsItemSiteMarkdownExtensions']:
                return InboxItemsItemSiteMarkdownExtensions
            name = schemas.StrSchema
            open_beta_date = schemas.IntSchema
        
            @staticmethod
            def related_sites() -> typing.Type['InboxItemsItemSiteRelatedSites']:
                return InboxItemsItemSiteRelatedSites
            site_state = schemas.StrSchema
            site_type = schemas.StrSchema
            site_url = schemas.StrSchema
        
            @staticmethod
            def styling() -> typing.Type['InboxItemsItemSiteStyling']:
                return InboxItemsItemSiteStyling
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["aliases"]) -> 'InboxItemsItemSiteAliases': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["markdown_extensions"]) -> 'InboxItemsItemSiteMarkdownExtensions': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["related_sites"]) -> 'InboxItemsItemSiteRelatedSites': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["styling"]) -> 'InboxItemsItemSiteStyling': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["aliases"]) -> typing.Union['InboxItemsItemSiteAliases', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["markdown_extensions"]) -> typing.Union['InboxItemsItemSiteMarkdownExtensions', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["related_sites"]) -> typing.Union['InboxItemsItemSiteRelatedSites', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["styling"]) -> typing.Union['InboxItemsItemSiteStyling', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        aliases: typing.Union['InboxItemsItemSiteAliases', schemas.Unset] = schemas.unset,
        ...
        markdown_extensions: typing.Union['InboxItemsItemSiteMarkdownExtensions', schemas.Unset] = schemas.unset,
        ...
        related_sites: typing.Union['InboxItemsItemSiteRelatedSites', schemas.Unset] = schemas.unset,
        ...
        styling: typing.Union['InboxItemsItemSiteStyling', schemas.Unset] = schemas.unset,
