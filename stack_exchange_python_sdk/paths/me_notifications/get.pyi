...
class BaseApi(api_client.Api):
    ...
    def _get_user_notifications_list_mapped_args(
        self,
        site: str,
    ...
    async def _aget_user_notifications_list_oapg(
        self,
    ...
    def _get_user_notifications_list_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserNotificationsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_notifications_list(
        self,
        site: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_notifications_list_mapped_args(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        return await self._aget_user_notifications_list_oapg(
    ...
    def get_user_notifications_list(
        ...
        return self._get_user_notifications_list_oapg(
            query_params=args.query,
        )

class GetUserNotificationsList(BaseApi):
    ...
    async def aget_user_notifications_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_notifications_list(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
    ...
    def get_user_notifications_list(
        ...
        raw_response = self.raw.get_user_notifications_list(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
