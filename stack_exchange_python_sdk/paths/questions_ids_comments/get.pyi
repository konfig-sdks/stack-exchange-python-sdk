...
class BaseApi(api_client.Api):
    ...
    def _get_comments_list_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_comments_list_oapg(
        self,
...
class GetCommentsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_comments_list(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_comments_list_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._aget_comments_list_oapg(
    ...
    def get_comments_list(
        ...
        return self._get_comments_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCommentsList(BaseApi):
    ...
    async def aget_comments_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_comments_list(
            ids=ids,
            site=site,
            order=order,
            max=max,
    ...
    def get_comments_list(
        ...
        raw_response = self.raw.get_comments_list(
            ids=ids,
            site=site,
            order=order,
            max=max,
