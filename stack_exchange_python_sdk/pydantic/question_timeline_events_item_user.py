...
from stack_exchange_python_sdk.pydantic.question_timeline_events_item_user_badge_counts import QuestionTimelineEventsItemUserBadgeCounts

class QuestionTimelineEventsItemUser(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[QuestionTimelineEventsItemUserBadgeCounts] = Field(None, alias='badge_counts')
