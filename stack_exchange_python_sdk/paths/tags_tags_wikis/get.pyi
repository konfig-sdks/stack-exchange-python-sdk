...
from stack_exchange_python_sdk.model.tag_wikis import TagWikis as TagWikisSchema

from stack_exchange_python_sdk.type.tag_wikis import TagWikis

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.tag_wikis import TagWikis as TagWikisPydantic
...
SchemaFor200ResponseBody = TagWikisSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_tag_wikis_mapped_args(
        self,
        tags: str,
        site: str,
    ...
    async def _aget_tag_wikis_oapg(
        self,
...
class GetTagWikisRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tag_wikis(
        self,
        tags: str,
        site: str,
        pagesize: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_tag_wikis_mapped_args(
            tags=tags,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        return await self._aget_tag_wikis_oapg(
    ...
    def get_tag_wikis(
        ...
        return self._get_tag_wikis_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTagWikis(BaseApi):
    ...
    async def aget_tag_wikis(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tag_wikis(
            tags=tags,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        if validate:
            return RootModel[TagWikisPydantic](raw_response.body).root
        return api_client.construct_model_instance(TagWikisPydantic, raw_response.body)
    ...
    def get_tag_wikis(
        ...
        raw_response = self.raw.get_tag_wikis(
            tags=tags,
            site=site,
            pagesize=pagesize,
            page=page,
