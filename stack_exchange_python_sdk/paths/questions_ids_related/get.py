...
class BaseApi(api_client.Api):
    ...
    def _list_related_questions_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _alist_related_questions_oapg(
        self,
    ...
    def _list_related_questions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListRelatedQuestionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_related_questions(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_related_questions_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._alist_related_questions_oapg(
    ...
    def list_related_questions(
        ...
        return self._list_related_questions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListRelatedQuestions(BaseApi):
    ...
    async def alist_related_questions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_related_questions(
            ids=ids,
            site=site,
            order=order,
            max=max,
    ...
    def list_related_questions(
        ...
        raw_response = self.raw.list_related_questions(
            ids=ids,
            site=site,
            order=order,
            max=max,
