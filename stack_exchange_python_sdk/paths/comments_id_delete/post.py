...
class BaseApi(api_client.Api):
    ...
    def _delete_action_mapped_args(
        self,
        id: int,
        site: str,
    ...
    async def _adelete_action_oapg(
        self,
...
class DeleteActionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_action(
        self,
        id: int,
        site: str,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._delete_action_mapped_args(
            id=id,
            site=site,
            filter=filter,
        ...
        return await self._adelete_action_oapg(
...
class DeleteAction(BaseApi):
    ...
    async def adelete_action(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_action(
            id=id,
            site=site,
            filter=filter,
            param_callback=param_callback,
    ...
    def delete_action(
        ...
        raw_response = self.raw.delete_action(
            id=id,
            site=site,
            filter=filter,
            param_callback=param_callback,
