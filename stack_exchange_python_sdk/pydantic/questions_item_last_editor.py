...
from stack_exchange_python_sdk.pydantic.questions_item_last_editor_badge_counts import QuestionsItemLastEditorBadgeCounts

class QuestionsItemLastEditor(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[QuestionsItemLastEditorBadgeCounts] = Field(None, alias='badge_counts')
