...
from stack_exchange_python_sdk.model.revisions import Revisions as RevisionsSchema

from stack_exchange_python_sdk.type.revisions import Revisions

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.revisions import Revisions as RevisionsPydantic
...
SchemaFor200ResponseBody = RevisionsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_post_revisions_by_ids_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_post_revisions_by_ids_oapg(
        self,
    ...
    def _get_post_revisions_by_ids_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetPostRevisionsByIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_post_revisions_by_ids(
        self,
        ids: str,
        site: str,
        fromdate: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_post_revisions_by_ids_mapped_args(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        return await self._aget_post_revisions_by_ids_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_post_revisions_by_ids(
        self,
        ids: str,
        site: str,
        fromdate: typing.Optional[int] = None,
        ...
        return self._get_post_revisions_by_ids_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPostRevisionsByIds(BaseApi):
    ...
    async def aget_post_revisions_by_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_post_revisions_by_ids(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        if validate:
            return RootModel[RevisionsPydantic](raw_response.body).root
        return api_client.construct_model_instance(RevisionsPydantic, raw_response.body)
    ...
    def get_post_revisions_by_ids(
        ...
        raw_response = self.raw.get_post_revisions_by_ids(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
