...
class BaseApi(api_client.Api):
    ...
    def _comments_by_ids_get_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _acomments_by_ids_get_oapg(
        self,
...
class CommentsByIdsGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acomments_by_ids_get(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._comments_by_ids_get_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._acomments_by_ids_get_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def comments_by_ids_get(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        return self._comments_by_ids_get_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class CommentsByIdsGet(BaseApi):
    ...
    async def acomments_by_ids_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acomments_by_ids_get(
            ids=ids,
            site=site,
            order=order,
            max=max,
    ...
    def comments_by_ids_get(
        ...
        raw_response = self.raw.comments_by_ids_get(
            ids=ids,
            site=site,
            order=order,
            max=max,
