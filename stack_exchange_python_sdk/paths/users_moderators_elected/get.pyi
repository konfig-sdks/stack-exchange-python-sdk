...
from stack_exchange_python_sdk.model.users import Users as UsersSchema

from stack_exchange_python_sdk.type.users import Users

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.users import Users as UsersPydantic
...
SchemaFor200ResponseBody = UsersSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_elected_moderator_users_mapped_args(
        self,
        site: str,
    ...
    async def _alist_elected_moderator_users_oapg(
        self,
    ...
    def _list_elected_moderator_users_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListElectedModeratorUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_elected_moderator_users(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_elected_moderator_users_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._alist_elected_moderator_users_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_elected_moderator_users(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        return self._list_elected_moderator_users_oapg(
            query_params=args.query,
        )

class ListElectedModeratorUsers(BaseApi):
    ...
    async def alist_elected_moderator_users(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_elected_moderator_users(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def list_elected_moderator_users(
        ...
        raw_response = self.raw.list_elected_moderator_users(
            site=site,
            order=order,
            max=max,
            min=min,
