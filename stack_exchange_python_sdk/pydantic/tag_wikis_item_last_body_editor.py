...
from stack_exchange_python_sdk.pydantic.tag_wikis_item_last_body_editor_badge_counts import TagWikisItemLastBodyEditorBadgeCounts

class TagWikisItemLastBodyEditor(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[TagWikisItemLastBodyEditorBadgeCounts] = Field(None, alias='badge_counts')
