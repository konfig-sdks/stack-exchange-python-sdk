...
class BaseApi(api_client.Api):
    ...
    def _get_user_badges_mapped_args(
        self,
        site: str,
    ...
    async def _aget_user_badges_oapg(
        self,
...
class GetUserBadgesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_badges(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_badges_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._aget_user_badges_oapg(
    ...
    def get_user_badges(
        ...
        return self._get_user_badges_oapg(
            query_params=args.query,
        )

class GetUserBadges(BaseApi):
    ...
    async def aget_user_badges(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_badges(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def get_user_badges(
        ...
        raw_response = self.raw.get_user_badges(
            site=site,
            order=order,
            max=max,
            min=min,
