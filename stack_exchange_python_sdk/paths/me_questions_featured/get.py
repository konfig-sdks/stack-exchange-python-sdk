...
class BaseApi(api_client.Api):
    ...
    def _get_user_featured_mapped_args(
        self,
        site: str,
    ...
    async def _aget_user_featured_oapg(
        self,
...
class GetUserFeaturedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_featured(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_featured_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._aget_user_featured_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_user_featured(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        return self._get_user_featured_oapg(
            query_params=args.query,
        )

class GetUserFeatured(BaseApi):
    ...
    async def aget_user_featured(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_featured(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def get_user_featured(
        ...
        raw_response = self.raw.get_user_featured(
            site=site,
            order=order,
            max=max,
            min=min,
