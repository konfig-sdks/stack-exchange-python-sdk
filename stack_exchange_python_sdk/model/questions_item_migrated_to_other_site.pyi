...
class QuestionsItemMigratedToOtherSite(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def aliases() -> typing.Type['QuestionsItemMigratedToOtherSiteAliases']:
                return QuestionsItemMigratedToOtherSiteAliases
            ...
            @staticmethod
            def markdown_extensions() -> typing.Type['QuestionsItemMigratedToOtherSiteMarkdownExtensions']:
                return QuestionsItemMigratedToOtherSiteMarkdownExtensions
            name = schemas.StrSchema
            open_beta_date = schemas.IntSchema
        
            @staticmethod
            def related_sites() -> typing.Type['QuestionsItemMigratedToOtherSiteRelatedSites']:
                return QuestionsItemMigratedToOtherSiteRelatedSites
            site_state = schemas.StrSchema
            site_type = schemas.StrSchema
            site_url = schemas.StrSchema
        
            @staticmethod
            def styling() -> typing.Type['QuestionsItemMigratedToOtherSiteStyling']:
                return QuestionsItemMigratedToOtherSiteStyling
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["aliases"]) -> 'QuestionsItemMigratedToOtherSiteAliases': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["markdown_extensions"]) -> 'QuestionsItemMigratedToOtherSiteMarkdownExtensions': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["related_sites"]) -> 'QuestionsItemMigratedToOtherSiteRelatedSites': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["styling"]) -> 'QuestionsItemMigratedToOtherSiteStyling': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["aliases"]) -> typing.Union['QuestionsItemMigratedToOtherSiteAliases', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["markdown_extensions"]) -> typing.Union['QuestionsItemMigratedToOtherSiteMarkdownExtensions', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["related_sites"]) -> typing.Union['QuestionsItemMigratedToOtherSiteRelatedSites', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["styling"]) -> typing.Union['QuestionsItemMigratedToOtherSiteStyling', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        aliases: typing.Union['QuestionsItemMigratedToOtherSiteAliases', schemas.Unset] = schemas.unset,
        ...
        markdown_extensions: typing.Union['QuestionsItemMigratedToOtherSiteMarkdownExtensions', schemas.Unset] = schemas.unset,
        ...
        related_sites: typing.Union['QuestionsItemMigratedToOtherSiteRelatedSites', schemas.Unset] = schemas.unset,
        ...
        styling: typing.Union['QuestionsItemMigratedToOtherSiteStyling', schemas.Unset] = schemas.unset,
    ...
    ) -> 'QuestionsItemMigratedToOtherSite':
