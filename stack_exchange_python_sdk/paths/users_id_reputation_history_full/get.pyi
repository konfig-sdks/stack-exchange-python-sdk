...
from stack_exchange_python_sdk.model.reputation_history import ReputationHistory as ReputationHistorySchema

from stack_exchange_python_sdk.type.reputation_history import ReputationHistory

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.reputation_history import ReputationHistory as ReputationHistoryPydantic
...
SchemaFor200ResponseBody = ReputationHistorySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReputationHistory
...
class BaseApi(api_client.Api):
    ...
    def _get_full_reputation_history_mapped_args(
        self,
        id: int,
        site: str,
    ...
    async def _aget_full_reputation_history_oapg(
        self,
    ...
    def _get_full_reputation_history_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetFullReputationHistoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_full_reputation_history(
        self,
        id: int,
        site: str,
        pagesize: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_full_reputation_history_mapped_args(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        return await self._aget_full_reputation_history_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_full_reputation_history(
        self,
        id: int,
        site: str,
        pagesize: typing.Optional[int] = None,
        ...
        return self._get_full_reputation_history_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFullReputationHistory(BaseApi):
    ...
    async def aget_full_reputation_history(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReputationHistoryPydantic:
        raw_response = await self.raw.aget_full_reputation_history(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        if validate:
            return RootModel[ReputationHistoryPydantic](raw_response.body).root
        return api_client.construct_model_instance(ReputationHistoryPydantic, raw_response.body)
    ...
    def get_full_reputation_history(
        ...
        raw_response = self.raw.get_full_reputation_history(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
