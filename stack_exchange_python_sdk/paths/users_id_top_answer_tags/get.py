...
from stack_exchange_python_sdk.model.top_tag_objects import TopTagObjects as TopTagObjectsSchema

from stack_exchange_python_sdk.type.top_tag_objects import TopTagObjects

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.top_tag_objects import TopTagObjects as TopTagObjectsPydantic
...
SchemaFor200ResponseBody = TopTagObjectsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_user_top_answer_tags_mapped_args(
        self,
        id: int,
        site: str,
    ...
    async def _aget_user_top_answer_tags_oapg(
        self,
    ...
    def _get_user_top_answer_tags_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserTopAnswerTagsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_top_answer_tags(
        self,
        id: int,
        site: str,
        pagesize: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_top_answer_tags_mapped_args(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        return await self._aget_user_top_answer_tags_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_user_top_answer_tags(
        self,
        id: int,
        site: str,
        pagesize: typing.Optional[int] = None,
        ...
        return self._get_user_top_answer_tags_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserTopAnswerTags(BaseApi):
    ...
    async def aget_user_top_answer_tags(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TopTagObjectsPydantic:
        raw_response = await self.raw.aget_user_top_answer_tags(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        if validate:
            return RootModel[TopTagObjectsPydantic](raw_response.body).root
        return api_client.construct_model_instance(TopTagObjectsPydantic, raw_response.body)
    ...
    def get_user_top_answer_tags(
        ...
        raw_response = self.raw.get_user_top_answer_tags(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
