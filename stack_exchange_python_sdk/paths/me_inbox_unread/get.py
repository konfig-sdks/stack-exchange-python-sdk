...
from stack_exchange_python_sdk.model.inbox_items import InboxItems as InboxItemsSchema

from stack_exchange_python_sdk.type.inbox_items import InboxItems

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.inbox_items import InboxItems as InboxItemsPydantic
...
SchemaFor200ResponseBody = InboxItemsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_unread_items_in_inbox_mapped_args(
        self,
        site: str,
    ...
    async def _aget_unread_items_in_inbox_oapg(
        self,
    ...
    def _get_unread_items_in_inbox_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUnreadItemsInInboxRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_unread_items_in_inbox(
        self,
        site: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_unread_items_in_inbox_mapped_args(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        return await self._aget_unread_items_in_inbox_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_unread_items_in_inbox(
        self,
        site: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        return self._get_unread_items_in_inbox_oapg(
            query_params=args.query,
        )

class GetUnreadItemsInInbox(BaseApi):
    ...
    async def aget_unread_items_in_inbox(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_unread_items_in_inbox(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        if validate:
            return RootModel[InboxItemsPydantic](raw_response.body).root
        return api_client.construct_model_instance(InboxItemsPydantic, raw_response.body)
    ...
    def get_unread_items_in_inbox(
        ...
        raw_response = self.raw.get_unread_items_in_inbox(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
