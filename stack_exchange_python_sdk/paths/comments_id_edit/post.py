...
from stack_exchange_python_sdk.model.created_comment import CreatedComment as CreatedCommentSchema

from stack_exchange_python_sdk.type.created_comment import CreatedComment

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.created_comment import CreatedComment as CreatedCommentPydantic
...
SchemaFor200ResponseBody = CreatedCommentSchema
...
class BaseApi(api_client.Api):
    ...
    def _edit_existing_mapped_args(
        self,
        id: int,
        site: str,
    ...
    async def _aedit_existing_oapg(
        self,
...
class EditExistingRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_existing(
        self,
        id: int,
        site: str,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._edit_existing_mapped_args(
            id=id,
            site=site,
            filter=filter,
        ...
        return await self._aedit_existing_oapg(
    ...
    def edit_existing(
        ...
        return self._edit_existing_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class EditExisting(BaseApi):
    ...
    async def aedit_existing(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CreatedCommentPydantic:
        raw_response = await self.raw.aedit_existing(
            id=id,
            site=site,
            filter=filter,
            param_callback=param_callback,
        ...
        if validate:
            return CreatedCommentPydantic(**raw_response.body)
        return api_client.construct_model_instance(CreatedCommentPydantic, raw_response.body)
    ...
    def edit_existing(
        ...
        raw_response = self.raw.edit_existing(
            id=id,
            site=site,
            filter=filter,
            param_callback=param_callback,
