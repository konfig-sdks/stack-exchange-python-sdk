...
class BaseApi(api_client.Api):
    ...
    def _list_user_badges_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _alist_user_badges_oapg(
        self,
...
class ListUserBadgesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_user_badges(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_user_badges_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._alist_user_badges_oapg(
    ...
    def list_user_badges(
        ...
        return self._list_user_badges_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListUserBadges(BaseApi):
    ...
    async def alist_user_badges(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_user_badges(
            ids=ids,
            site=site,
            order=order,
            max=max,
    ...
    def list_user_badges(
        ...
        raw_response = self.raw.list_user_badges(
            ids=ids,
            site=site,
            order=order,
            max=max,
