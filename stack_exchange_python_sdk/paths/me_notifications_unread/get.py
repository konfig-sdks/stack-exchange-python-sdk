...
class BaseApi(api_client.Api):
    ...
    def _get_unread_items_in_inbox_0_mapped_args(
        self,
        site: str,
    ...
    async def _aget_unread_items_in_inbox_0_oapg(
        self,
    ...
    def _get_unread_items_in_inbox_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUnreadItemsInInbox0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_unread_items_in_inbox_0(
        self,
        site: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_unread_items_in_inbox_0_mapped_args(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        return await self._aget_unread_items_in_inbox_0_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_unread_items_in_inbox_0(
        self,
        site: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        return self._get_unread_items_in_inbox_0_oapg(
            query_params=args.query,
        )

class GetUnreadItemsInInbox0(BaseApi):
    ...
    async def aget_unread_items_in_inbox_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_unread_items_in_inbox_0(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
    ...
    def get_unread_items_in_inbox_0(
        ...
        raw_response = self.raw.get_unread_items_in_inbox_0(
            site=site,
            pagesize=pagesize,
            page=page,
            filter=filter,
