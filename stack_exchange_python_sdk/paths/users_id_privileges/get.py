...
from stack_exchange_python_sdk.model.privileges import Privileges as PrivilegesSchema

from stack_exchange_python_sdk.type.privileges import Privileges

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.privileges import Privileges as PrivilegesPydantic
...
SchemaFor200ResponseBody = PrivilegesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_privileges_list_mapped_args(
        self,
        id: int,
        site: str,
    ...
    async def _aget_privileges_list_oapg(
        self,
...
class GetPrivilegesListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_privileges_list(
        self,
        id: int,
        site: str,
        pagesize: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_privileges_list_mapped_args(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        return await self._aget_privileges_list_oapg(
    ...
    def get_privileges_list(
        ...
        return self._get_privileges_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPrivilegesList(BaseApi):
    ...
    async def aget_privileges_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_privileges_list(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        if validate:
            return RootModel[PrivilegesPydantic](raw_response.body).root
        return api_client.construct_model_instance(PrivilegesPydantic, raw_response.body)
    ...
    def get_privileges_list(
        ...
        raw_response = self.raw.get_privileges_list(
            id=id,
            site=site,
            pagesize=pagesize,
            page=page,
