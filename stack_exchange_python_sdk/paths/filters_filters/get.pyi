...
from stack_exchange_python_sdk.model.filters import Filters as FiltersSchema

from stack_exchange_python_sdk.type.filters import Filters

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.filters import Filters as FiltersPydantic

# Path params
FiltersSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'filters': typing.Union[FiltersSchema, str, ],
    }
)
...
SchemaFor200ResponseBody = FiltersSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_filter_details_by_ids_mapped_args(
        self,
        filters: str,
    ...
    async def _aget_filter_details_by_ids_oapg(
        self,
    ...
    def _get_filter_details_by_ids_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetFilterDetailsByIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_filter_details_by_ids(
        self,
        filters: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_filter_details_by_ids_mapped_args(
            filters=filters,
        )
        return await self._aget_filter_details_by_ids_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_filter_details_by_ids(
        self,
        filters: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_filter_details_by_ids_oapg(
            path_params=args.path,
        )

class GetFilterDetailsByIds(BaseApi):
    ...
    async def aget_filter_details_by_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_filter_details_by_ids(
            filters=filters,
            **kwargs,
        )
        if validate:
            return RootModel[FiltersPydantic](raw_response.body).root
    ...
    def get_filter_details_by_ids(
        ...
        raw_response = self.raw.get_filter_details_by_ids(
            filters=filters,
        )
        if validate:
            return RootModel[FiltersPydantic](raw_response.body).root
