...
from stack_exchange_python_sdk.model.error import Error as ErrorSchema

from stack_exchange_python_sdk.type.error import Error

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.error import Error as ErrorPydantic
...
SchemaFor200ResponseBody = ErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _generate_error_mapped_args(
        self,
        id: int,
    ...
    async def _agenerate_error_oapg(
        self,
...
class GenerateErrorRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_error(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._generate_error_mapped_args(
            id=id,
        )
        return await self._agenerate_error_oapg(
    ...
    def generate_error(
        ...
        return self._generate_error_oapg(
            path_params=args.path,
        )

class GenerateError(BaseApi):
    ...
    async def agenerate_error(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_error(
            id=id,
            **kwargs,
        )
        if validate:
            return ErrorPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorPydantic, raw_response.body)
    ...
    def generate_error(
        ...
        raw_response = self.raw.generate_error(
            id=id,
        )
        if validate:
            return ErrorPydantic(**raw_response.body)
