...
from stack_exchange_python_sdk.pydantic.questions_item_bounty_user_badge_counts import QuestionsItemBountyUserBadgeCounts

class QuestionsItemBountyUser(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[QuestionsItemBountyUserBadgeCounts] = Field(None, alias='badge_counts')
