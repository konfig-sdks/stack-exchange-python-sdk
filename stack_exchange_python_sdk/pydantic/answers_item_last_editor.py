...
from stack_exchange_python_sdk.pydantic.answers_item_last_editor_badge_counts import AnswersItemLastEditorBadgeCounts

class AnswersItemLastEditor(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[AnswersItemLastEditorBadgeCounts] = Field(None, alias='badge_counts')
