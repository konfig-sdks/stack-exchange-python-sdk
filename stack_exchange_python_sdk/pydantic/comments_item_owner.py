...
from stack_exchange_python_sdk.pydantic.comments_item_owner_badge_counts import CommentsItemOwnerBadgeCounts

class CommentsItemOwner(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[CommentsItemOwnerBadgeCounts] = Field(None, alias='badge_counts')
