...
from stack_exchange_python_sdk.model.posts import Posts as PostsSchema

from stack_exchange_python_sdk.type.posts import Posts

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.posts import Posts as PostsPydantic
...
SchemaFor200ResponseBody = PostsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_posts_by_ids_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_posts_by_ids_oapg(
        self,
...
class GetPostsByIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_posts_by_ids(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_posts_by_ids_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._aget_posts_by_ids_oapg(
    ...
    def get_posts_by_ids(
        ...
        return self._get_posts_by_ids_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPostsByIds(BaseApi):
    ...
    async def aget_posts_by_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_posts_by_ids(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        if validate:
            return RootModel[PostsPydantic](raw_response.body).root
        return api_client.construct_model_instance(PostsPydantic, raw_response.body)
    ...
    def get_posts_by_ids(
        ...
        raw_response = self.raw.get_posts_by_ids(
            ids=ids,
            site=site,
            order=order,
            max=max,
