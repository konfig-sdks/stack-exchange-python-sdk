...
from stack_exchange_python_sdk.model.single_filter import SingleFilter as SingleFilterSchema

from stack_exchange_python_sdk.type.single_filter import SingleFilter

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.single_filter import SingleFilter as SingleFilterPydantic
...
UnsafeSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'unsafe': typing.Union[UnsafeSchema, bool, ],
    },
    total=False
)
...
request_query_unsafe = api_client.QueryParameter(
    name="unsafe",
    style=api_client.ParameterStyle.FORM,
    schema=UnsafeSchema,
    explode=True,
)
SchemaFor200ResponseBody = SingleFilterSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_filter_mapped_args(
        ...
        unsafe: typing.Optional[bool] = None,
...
class CreateFilter(BaseApi):
    ...
    async def acreate_filter(
        ...
        **kwargs,
        ...
        if validate:
            return SingleFilterPydantic(**raw_response.body)
        return api_client.construct_model_instance(SingleFilterPydantic, raw_response.body)
