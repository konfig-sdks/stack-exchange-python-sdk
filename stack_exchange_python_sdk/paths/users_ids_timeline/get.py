...
from stack_exchange_python_sdk.model.user_timeline_objects import UserTimelineObjects as UserTimelineObjectsSchema

from stack_exchange_python_sdk.type.user_timeline_objects import UserTimelineObjects

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.user_timeline_objects import UserTimelineObjects as UserTimelineObjectsPydantic
...
SchemaFor200ResponseBody = UserTimelineObjectsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserTimelineObjects
...
class BaseApi(api_client.Api):
    ...
    def _get_user_timeline_by_ids_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_user_timeline_by_ids_oapg(
        self,
    ...
    def _get_user_timeline_by_ids_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserTimelineByIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_timeline_by_ids(
        self,
        ids: str,
        site: str,
        fromdate: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_timeline_by_ids_mapped_args(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        return await self._aget_user_timeline_by_ids_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_user_timeline_by_ids(
        self,
        ids: str,
        site: str,
        fromdate: typing.Optional[int] = None,
        ...
        return self._get_user_timeline_by_ids_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserTimelineByIds(BaseApi):
    ...
    async def aget_user_timeline_by_ids(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserTimelineObjectsPydantic:
        raw_response = await self.raw.aget_user_timeline_by_ids(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        if validate:
            return RootModel[UserTimelineObjectsPydantic](raw_response.body).root
        return api_client.construct_model_instance(UserTimelineObjectsPydantic, raw_response.body)
    ...
    def get_user_timeline_by_ids(
        ...
        raw_response = self.raw.get_user_timeline_by_ids(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
