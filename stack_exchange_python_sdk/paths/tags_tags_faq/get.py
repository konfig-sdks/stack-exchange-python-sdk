...
class BaseApi(api_client.Api):
    ...
    def _get_faq_questions_mapped_args(
        self,
        tags: str,
        site: str,
    ...
    async def _aget_faq_questions_oapg(
        self,
...
class GetFaqQuestionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_faq_questions(
        self,
        tags: str,
        site: str,
        pagesize: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_faq_questions_mapped_args(
            tags=tags,
            site=site,
            pagesize=pagesize,
            page=page,
        ...
        return await self._aget_faq_questions_oapg(
    ...
    def get_faq_questions(
        ...
        return self._get_faq_questions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFaqQuestions(BaseApi):
    ...
    async def aget_faq_questions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_faq_questions(
            tags=tags,
            site=site,
            pagesize=pagesize,
            page=page,
    ...
    def get_faq_questions(
        ...
        raw_response = self.raw.get_faq_questions(
            tags=tags,
            site=site,
            pagesize=pagesize,
            page=page,
