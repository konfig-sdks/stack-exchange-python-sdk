...
from stack_exchange_python_sdk.pydantic.comments_item_reply_to_user_badge_counts import CommentsItemReplyToUserBadgeCounts

class CommentsItemReplyToUser(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[CommentsItemReplyToUserBadgeCounts] = Field(None, alias='badge_counts')
