...
class BaseApi(api_client.Api):
    ...
    def _similar_questions_search_mapped_args(
        self,
        site: str,
    ...
    async def _asimilar_questions_search_oapg(
        self,
    ...
    def _similar_questions_search_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SimilarQuestionsSearchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asimilar_questions_search(
        self,
        site: str,
        tagged: typing.Optional[str] = None,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._similar_questions_search_mapped_args(
            site=site,
            tagged=tagged,
            order=order,
            max=max,
        ...
        return await self._asimilar_questions_search_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def similar_questions_search(
        self,
        site: str,
        tagged: typing.Optional[str] = None,
        order: typing.Optional[str] = None,
        ...
        return self._similar_questions_search_oapg(
            query_params=args.query,
        )

class SimilarQuestionsSearch(BaseApi):
    ...
    async def asimilar_questions_search(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asimilar_questions_search(
            site=site,
            tagged=tagged,
            order=order,
            max=max,
    ...
    def similar_questions_search(
        ...
        raw_response = self.raw.similar_questions_search(
            site=site,
            tagged=tagged,
            order=order,
            max=max,
