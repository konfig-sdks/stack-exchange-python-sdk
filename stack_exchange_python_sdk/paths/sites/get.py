...
from stack_exchange_python_sdk.model.sites import Sites as SitesSchema

from stack_exchange_python_sdk.type.sites import Sites

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.sites import Sites as SitesPydantic
...
SchemaFor200ResponseBody = SitesSchema
...
class ListSitesRaw(BaseApi):
    ...
    async def alist_sites(
        ...
        **kwargs,
        ...
        args = self._list_sites_mapped_args(
            pagesize=pagesize,
            page=page,
            filter=filter,
            param_callback=param_callback,
        )
        return await self._alist_sites_oapg(
...
class ListSites(BaseApi):
    ...
    async def alist_sites(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_sites(
            pagesize=pagesize,
            page=page,
            filter=filter,
            param_callback=param_callback,
        ...
        if validate:
            return RootModel[SitesPydantic](raw_response.body).root
        return api_client.construct_model_instance(SitesPydantic, raw_response.body)
    ...
    def list_sites(
        ...
        raw_response = self.raw.list_sites(
            pagesize=pagesize,
            page=page,
            filter=filter,
            param_callback=param_callback,
