...
from stack_exchange_python_sdk.pydantic.suggested_edits_item_proposing_user_badge_counts import SuggestedEditsItemProposingUserBadgeCounts

class SuggestedEditsItemProposingUser(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[SuggestedEditsItemProposingUserBadgeCounts] = Field(None, alias='badge_counts')
