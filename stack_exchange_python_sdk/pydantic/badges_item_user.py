...
from stack_exchange_python_sdk.pydantic.badges_item_user_badge_counts import BadgesItemUserBadgeCounts

class BadgesItemUser(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[BadgesItemUserBadgeCounts] = Field(None, alias='badge_counts')
