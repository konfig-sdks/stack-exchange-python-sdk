...
class BaseApi(api_client.Api):
    ...
    def _get_list_by_ids_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_list_by_ids_oapg(
        self,
...
class GetListByIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_list_by_ids(
        self,
        ids: str,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_list_by_ids_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._aget_list_by_ids_oapg(
    ...
    def get_list_by_ids(
        ...
        return self._get_list_by_ids_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetListByIds(BaseApi):
    ...
    async def aget_list_by_ids(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_list_by_ids(
            ids=ids,
            site=site,
            order=order,
            max=max,
    ...
    def get_list_by_ids(
        ...
        raw_response = self.raw.get_list_by_ids(
            ids=ids,
            site=site,
            order=order,
            max=max,
