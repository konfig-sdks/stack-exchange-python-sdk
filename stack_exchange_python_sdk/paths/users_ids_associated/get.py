...
from stack_exchange_python_sdk.model.network_users import NetworkUsers as NetworkUsersSchema

from stack_exchange_python_sdk.type.network_users import NetworkUsers

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.network_users import NetworkUsers as NetworkUsersPydantic
...
SchemaFor200ResponseBody = NetworkUsersSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_associated_accounts_mapped_args(
        self,
        ids: str,
    ...
    async def _aget_associated_accounts_oapg(
        self,
    ...
    def _get_associated_accounts_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAssociatedAccountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_associated_accounts(
        self,
        ids: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_associated_accounts_mapped_args(
            ids=ids,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        return await self._aget_associated_accounts_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_associated_accounts(
        self,
        ids: str,
        pagesize: typing.Optional[int] = None,
        page: typing.Optional[int] = None,
        ...
        return self._get_associated_accounts_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAssociatedAccounts(BaseApi):
    ...
    async def aget_associated_accounts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NetworkUsersPydantic:
        raw_response = await self.raw.aget_associated_accounts(
            ids=ids,
            pagesize=pagesize,
            page=page,
            filter=filter,
        ...
        if validate:
            return RootModel[NetworkUsersPydantic](raw_response.body).root
        return api_client.construct_model_instance(NetworkUsersPydantic, raw_response.body)
    ...
    def get_associated_accounts(
        ...
        raw_response = self.raw.get_associated_accounts(
            ids=ids,
            pagesize=pagesize,
            page=page,
            filter=filter,
