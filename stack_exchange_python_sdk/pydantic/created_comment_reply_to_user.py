...
from stack_exchange_python_sdk.pydantic.created_comment_reply_to_user_badge_counts import CreatedCommentReplyToUserBadgeCounts

class CreatedCommentReplyToUser(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[CreatedCommentReplyToUserBadgeCounts] = Field(None, alias='badge_counts')
