...
from stack_exchange_python_sdk.pydantic.posts_item_owner_badge_counts import PostsItemOwnerBadgeCounts

class PostsItemOwner(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[PostsItemOwnerBadgeCounts] = Field(None, alias='badge_counts')
