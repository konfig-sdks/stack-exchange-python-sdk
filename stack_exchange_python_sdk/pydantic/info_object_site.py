...
from stack_exchange_python_sdk.pydantic.info_object_site_aliases import InfoObjectSiteAliases
from stack_exchange_python_sdk.pydantic.info_object_site_markdown_extensions import InfoObjectSiteMarkdownExtensions
from stack_exchange_python_sdk.pydantic.info_object_site_related_sites import InfoObjectSiteRelatedSites
from stack_exchange_python_sdk.pydantic.info_object_site_styling import InfoObjectSiteStyling

class InfoObjectSite(BaseModel):
    aliases: typing.Optional[InfoObjectSiteAliases] = Field(None, alias='aliases')
    ...
    markdown_extensions: typing.Optional[InfoObjectSiteMarkdownExtensions] = Field(None, alias='markdown_extensions')

    name: typing.Optional[str] = Field(None, alias='name')

    open_beta_date: typing.Optional[int] = Field(None, alias='open_beta_date')

    related_sites: typing.Optional[InfoObjectSiteRelatedSites] = Field(None, alias='related_sites')
    ...
    styling: typing.Optional[InfoObjectSiteStyling] = Field(None, alias='styling')
