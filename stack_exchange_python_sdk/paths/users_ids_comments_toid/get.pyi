...
from stack_exchange_python_sdk.model.comments import Comments as CommentsSchema

from stack_exchange_python_sdk.type.comments import Comments

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.comments import Comments as CommentsPydantic
...
ToidSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ids': typing.Union[IdsSchema, str, ],
        'toid': typing.Union[ToidSchema, decimal.Decimal, int, ],
    }
)
...
request_path_toid = api_client.PathParameter(
    name="toid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ToidSchema,
    required=True,
)
SchemaFor200ResponseBody = CommentsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_user_comments_by_ids_and_toid_mapped_args(
        self,
        ids: str,
        toid: int,
        site: str,
        ...
        if toid is not None:
            _path_params["toid"] = toid
        args.query = _query_params
        args.path = _path_params
        return args

    async def _aget_user_comments_by_ids_and_toid_oapg(
        self,
    ...
    def _get_user_comments_by_ids_and_toid_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserCommentsByIdsAndToidRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_comments_by_ids_and_toid(
        self,
        ids: str,
        toid: int,
        site: str,
        ...
        **kwargs,
        ...
        args = self._get_user_comments_by_ids_and_toid_mapped_args(
            ids=ids,
            toid=toid,
            site=site,
            order=order,
        ...
        return await self._aget_user_comments_by_ids_and_toid_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_user_comments_by_ids_and_toid(
        self,
        ids: str,
        toid: int,
        site: str,
        ...
        return self._get_user_comments_by_ids_and_toid_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserCommentsByIdsAndToid(BaseApi):
    ...
    async def aget_user_comments_by_ids_and_toid(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_comments_by_ids_and_toid(
            ids=ids,
            toid=toid,
            site=site,
            order=order,
    ...
    def get_user_comments_by_ids_and_toid(
        ...
        raw_response = self.raw.get_user_comments_by_ids_and_toid(
            ids=ids,
            toid=toid,
            site=site,
            order=order,
