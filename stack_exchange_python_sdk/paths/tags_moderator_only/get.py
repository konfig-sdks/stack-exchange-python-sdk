...
from stack_exchange_python_sdk.model.tags import Tags as TagsSchema

from stack_exchange_python_sdk.type.tags import Tags

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.tags import Tags as TagsPydantic

from . import path

# Query params
InnameSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'inname': typing.Union[InnameSchema, str, ],
...
request_query_inname = api_client.QueryParameter(
    name="inname",
...
SchemaFor200ResponseBody = TagsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_moderator_only_tags_list_mapped_args(
        self,
        site: str,
        inname: typing.Optional[str] = None,
    ...
    async def _aget_moderator_only_tags_list_oapg(
        self,
    ...
    def _get_moderator_only_tags_list_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetModeratorOnlyTagsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_moderator_only_tags_list(
        self,
        site: str,
        inname: typing.Optional[str] = None,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_moderator_only_tags_list_mapped_args(
            site=site,
            inname=inname,
            order=order,
            max=max,
        ...
        return await self._aget_moderator_only_tags_list_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_moderator_only_tags_list(
        self,
        site: str,
        inname: typing.Optional[str] = None,
        order: typing.Optional[str] = None,
        ...
        return self._get_moderator_only_tags_list_oapg(
            query_params=args.query,
        )

class GetModeratorOnlyTagsList(BaseApi):
    ...
    async def aget_moderator_only_tags_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_moderator_only_tags_list(
            site=site,
            inname=inname,
            order=order,
            max=max,
        ...
        if validate:
            return RootModel[TagsPydantic](raw_response.body).root
        return api_client.construct_model_instance(TagsPydantic, raw_response.body)
    ...
    def get_moderator_only_tags_list(
        ...
        raw_response = self.raw.get_moderator_only_tags_list(
            site=site,
            inname=inname,
            order=order,
            max=max,
