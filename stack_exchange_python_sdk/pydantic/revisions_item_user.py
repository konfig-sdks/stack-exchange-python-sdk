...
from stack_exchange_python_sdk.pydantic.revisions_item_user_badge_counts import RevisionsItemUserBadgeCounts

class RevisionsItemUser(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[RevisionsItemUserBadgeCounts] = Field(None, alias='badge_counts')
