...
class GetTagsRaw(BaseApi):
    ...
    async def aget_tags(
        ...
        **kwargs,
        ...
        args = self._get_tags_mapped_args(
            ids=ids,
            site=site,
            order=order,
            max=max,
        ...
        return await self._aget_tags_oapg(
...
class GetTags(BaseApi):
    ...
    async def aget_tags(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tags(
            ids=ids,
            site=site,
            order=order,
            max=max,
    ...
    def get_tags(
        ...
        raw_response = self.raw.get_tags(
            ids=ids,
            site=site,
            order=order,
            max=max,
