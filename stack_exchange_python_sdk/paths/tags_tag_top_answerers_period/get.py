...
class BaseApi(api_client.Api):
    ...
    def _tag_top_answerers_mapped_args(
        self,
        tag: str,
        period: str,
        site: str,
    ...
    async def _atag_top_answerers_oapg(
        self,
...
class TagTopAnswerersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atag_top_answerers(
        self,
        tag: str,
        period: str,
        site: str,
        ...
        **kwargs,
        ...
        args = self._tag_top_answerers_mapped_args(
            tag=tag,
            period=period,
            site=site,
            pagesize=pagesize,
        ...
        return await self._atag_top_answerers_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def tag_top_answerers(
        self,
        tag: str,
        period: str,
        site: str,
        ...
        return self._tag_top_answerers_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class TagTopAnswerers(BaseApi):
    ...
    async def atag_top_answerers(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atag_top_answerers(
            tag=tag,
            period=period,
            site=site,
            pagesize=pagesize,
    ...
    def tag_top_answerers(
        ...
        raw_response = self.raw.tag_top_answerers(
            tag=tag,
            period=period,
            site=site,
            pagesize=pagesize,
