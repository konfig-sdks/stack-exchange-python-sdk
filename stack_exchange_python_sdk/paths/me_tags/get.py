...
class BaseApi(api_client.Api):
    ...
    def _get_user_tags_list_mapped_args(
        self,
        site: str,
    ...
    async def _aget_user_tags_list_oapg(
        self,
...
class GetUserTagsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_tags_list(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_tags_list_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._aget_user_tags_list_oapg(
    ...
    def get_user_tags_list(
        ...
        return self._get_user_tags_list_oapg(
            query_params=args.query,
        )

class GetUserTagsList(BaseApi):
    ...
    async def aget_user_tags_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_tags_list(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def get_user_tags_list(
        ...
        raw_response = self.raw.get_user_tags_list(
            site=site,
            order=order,
            max=max,
            min=min,
