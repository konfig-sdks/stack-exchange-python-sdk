...
request_path_to_id = api_client.PathParameter(
    name="toId",
...
class BaseApi(api_client.Api):
    ...
    def _get_reply_list_mapped_args(
        self,
        to_id: int,
        site: str,
    ...
    async def _aget_reply_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/comments/{toId}',
            headers=_headers,
        )
...
class GetReplyListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_reply_list(
        self,
        to_id: int,
        site: str,
        order: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_reply_list_mapped_args(
            to_id=to_id,
            site=site,
            order=order,
            max=max,
        ...
        return await self._aget_reply_list_oapg(
    ...
    def get_reply_list(
        ...
        return self._get_reply_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetReplyList(BaseApi):
    ...
    async def aget_reply_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_reply_list(
            to_id=to_id,
            site=site,
            order=order,
            max=max,
    ...
    def get_reply_list(
        ...
        raw_response = self.raw.get_reply_list(
            to_id=to_id,
            site=site,
            order=order,
            max=max,
