...
from stack_exchange_python_sdk.pydantic.questions_item_owner_badge_counts import QuestionsItemOwnerBadgeCounts

class QuestionsItemOwner(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[QuestionsItemOwnerBadgeCounts] = Field(None, alias='badge_counts')
