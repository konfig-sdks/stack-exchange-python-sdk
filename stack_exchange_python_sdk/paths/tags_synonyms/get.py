...
class BaseApi(api_client.Api):
    ...
    def _synonyms_list_mapped_args(
        self,
        site: str,
    ...
    async def _asynonyms_list_oapg(
        self,
...
class SynonymsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asynonyms_list(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._synonyms_list_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._asynonyms_list_oapg(
    ...
    def synonyms_list(
        ...
        return self._synonyms_list_oapg(
            query_params=args.query,
        )

class SynonymsList(BaseApi):
    ...
    async def asynonyms_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asynonyms_list(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def synonyms_list(
        ...
        raw_response = self.raw.synonyms_list(
            site=site,
            order=order,
            max=max,
            min=min,
