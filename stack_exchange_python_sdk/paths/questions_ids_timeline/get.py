...
from stack_exchange_python_sdk.model.question_timeline_events import QuestionTimelineEvents as QuestionTimelineEventsSchema

from stack_exchange_python_sdk.type.question_timeline_events import QuestionTimelineEvents

from ...api_client import Dictionary
from stack_exchange_python_sdk.pydantic.question_timeline_events import QuestionTimelineEvents as QuestionTimelineEventsPydantic
...
SchemaFor200ResponseBody = QuestionTimelineEventsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: QuestionTimelineEvents
...
class BaseApi(api_client.Api):
    ...
    def _get_timeline_events_mapped_args(
        self,
        ids: str,
        site: str,
    ...
    async def _aget_timeline_events_oapg(
        self,
...
class GetTimelineEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_timeline_events(
        self,
        ids: str,
        site: str,
        fromdate: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_timeline_events_mapped_args(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        return await self._aget_timeline_events_oapg(
    ...
    def get_timeline_events(
        ...
        return self._get_timeline_events_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTimelineEvents(BaseApi):
    ...
    async def aget_timeline_events(
        ...
        validate: bool = False,
        **kwargs,
    ) -> QuestionTimelineEventsPydantic:
        raw_response = await self.raw.aget_timeline_events(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
        ...
        if validate:
            return RootModel[QuestionTimelineEventsPydantic](raw_response.body).root
        return api_client.construct_model_instance(QuestionTimelineEventsPydantic, raw_response.body)
    ...
    def get_timeline_events(
        ...
        raw_response = self.raw.get_timeline_events(
            ids=ids,
            site=site,
            fromdate=fromdate,
            todate=todate,
