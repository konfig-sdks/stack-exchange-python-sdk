...
class BaseApi(api_client.Api):
    ...
    def _get_user_favorites_mapped_args(
        self,
        site: str,
    ...
    async def _aget_user_favorites_oapg(
        self,
...
class GetUserFavoritesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_favorites(
        self,
        site: str,
        order: typing.Optional[str] = None,
        max: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_favorites_mapped_args(
            site=site,
            order=order,
            max=max,
            min=min,
        ...
        return await self._aget_user_favorites_oapg(
    ...
    def get_user_favorites(
        ...
        return self._get_user_favorites_oapg(
            query_params=args.query,
        )

class GetUserFavorites(BaseApi):
    ...
    async def aget_user_favorites(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_favorites(
            site=site,
            order=order,
            max=max,
            min=min,
    ...
    def get_user_favorites(
        ...
        raw_response = self.raw.get_user_favorites(
            site=site,
            order=order,
            max=max,
            min=min,
