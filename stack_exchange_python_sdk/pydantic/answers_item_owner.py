...
from stack_exchange_python_sdk.pydantic.answers_item_owner_badge_counts import AnswersItemOwnerBadgeCounts

class AnswersItemOwner(BaseModel):
    accept_rate: typing.Optional[int] = Field(None, alias='accept_rate')

    badge_counts: typing.Optional[AnswersItemOwnerBadgeCounts] = Field(None, alias='badge_counts')
